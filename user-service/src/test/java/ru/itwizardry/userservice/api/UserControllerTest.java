...
class UserControllerTest {
    ...
    void create_returns201_andLocationHeader() throws Exception {
        ...
        mockMvc.perform(post("/api/users")
                ...
                .andExpect(jsonPath("$.createdAt").value(CREATED_AT_JSON));
    }
    ...
    void getAll_withoutAge_returns200_list() throws Exception {
        var users = List.of(
                new UserDto(1L, "Ivan", "ivan@test.com", 25, CREATED_AT),
                new UserDto(2L, "Petr", "petr@test.com", 30, CREATED_AT)
        );
        ...
        mockMvc.perform(get("/api/users"))
                ...
                .andExpect(jsonPath("$[0].createdAt").value(CREATED_AT_JSON));
    }
    ...
    void getAll_withAgeParam_returns200_filtered() throws Exception {
        ...
        mockMvc.perform(get("/api/users").param("age", "25"))
                .andExpect(status().isOk())
    ...
    void update_whenEmailExists_returns409_withApiError() throws Exception {
        ...
        Mockito.when(userService.updateUser(eq(1L), any(UserUpdateRequest.class)))
                .thenThrow(new EmailAlreadyExistsException("dup@test.com"));
